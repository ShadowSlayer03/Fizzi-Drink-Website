    ...
    return (
        <>
            <button
                ...
                className="navMenu fixed top-6 right-6 z-[150] flex items-center justify-center w-12 h-12 rounded-full bg-orange-500 hover:scale-110 transition-transform duration-300"
            >
